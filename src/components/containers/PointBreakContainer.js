      ...
      <div className="flex-row reverse w-row">
        <div className="column-7 w-col w-col-7">
          <img
            ...
            src={process.env.PUBLIC_URL + '/img/surf-camp.jpg'}
            width="244.5"
          />
        </div>
        <div className="column-3 w-col w-col-5">
          ...
          <p className="text-bottom" data-ix="float-in-on-scroll-2">
            By better understanding the various aspects of By better
            understanding the various aspects of surfing, By better
