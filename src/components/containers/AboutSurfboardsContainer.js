      ...
      <div className="flex-row w-row">
        <div className="column-3 w-col w-col-5">
          ...
          <p className="text-bottom" data-ix="float-in-on-scroll-2">
            They were invented in ancient Hawaii usually made of wood from local
            trees, such as koa, and were often over 460 cm in length and
            extremely heavy. Modern surfboards are made of polyurethane or
            polystyrene foam covered with layers of fiberglass cloth, and
            polyester or epoxy resin. The result is a light and strong surfboard
            that is buoyant and maneuverable.
          </p>
          <a className="text-link top" data-ix="float-in-on-scroll-3" href="#">
            Read More
          </a>
        </div>
