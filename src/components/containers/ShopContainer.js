        ...
        <article className='bg container w-container' id='surfboards'>
            ...
            <div className='slider w-slider' data-animation='slide' data-duration='500' data-infinite='1'>
                <div className='mask w-slider-mask'>
                    <ShopItem boardName = 'Chilli Rare Bird' scrollFloatingType = 'float-in-on-scroll'
                        floatingType = 'floating' src = {window.location.origin + '/img/chili-board.png'}
                        price = '$890' 
                    />

                    <ShopItem boardName = 'Emery NEM XF' scrollFloatingType = 'float-in-on-scroll-2'
                        floatingType = 'floating-2' src={window.location.origin + '/img/board-2.png'} 
                        price = '$900' 
                    />

                    <ShopItem boardName = 'Agency GROM' scrollFloatingType = 'float-in-on-scroll-3'
                        floatingType = 'floating' src={window.location.origin + '/img/surfboard-grom.png'} 
                        price = '$750' 
                    />
                </div>
