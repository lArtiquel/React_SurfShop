      ...
      >
        <header className="container in-nav w-container">
          <a className="w-nav-brand" href="#top">
            <img
              alt="Surfboard Logo"
              className="surfboard-logo"
              src={process.env.PUBLIC_URL + '/img/surfboard-logo.svg'}
              width={50}
            />
          </a>
          <nav className="nav-menu w-clearfix w-nav-menu" role="navigation">
            <a className="nav-link w-nav-link" href="#stories">
              Stories
            </a>
            <a className="nav-link w-nav-link" href="#shop">
              Shop
            </a>
            <a className="nav-link w-nav-link" href="#events">
              Events
            </a>
            <a className="nav-link w-nav-link" href="#camp">
              Our Camp
            </a>
          </nav>
